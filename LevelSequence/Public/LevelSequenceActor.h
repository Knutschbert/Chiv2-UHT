...
//CROSS-MODULE INCLUDE V2: -ModuleName=MovieScene -ObjectName=EMovieScenePlayerStatus -FallbackName=EMovieScenePlayerStatus
...
protected:
    UFUNCTION(BlueprintCallable)
    void SequencePlaybackUpdated(UMovieSceneSequencePlayer* Sequence, TEnumAsByte<EMovieScenePlayerStatus::Type> Status);
