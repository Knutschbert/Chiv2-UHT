...
#include "EMovieScenePlayerStatusK2.h"
...
#include "OnMovieSceneSequencePlaybackStatusEventDelegate.h"
...
public:
    ...
    UPROPERTY(BlueprintAssignable, BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FOnMovieSceneSequencePlaybackStatusEvent OnPlaybackStatusChanged;
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, ReplicatedUsing=OnRep_PlaybackCompleted, meta=(AllowPrivateAccess=true))
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    void SetPlaybackStatusInternal(TEnumAsByte<EMovieScenePlayerStatus::Type> InStatus);
...
public:
    ...
    EMovieScenePlayerStatusK2 K2_GetPlaybackStatus() const;
