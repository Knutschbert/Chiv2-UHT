...
void UMovieSceneSequencePlayer::SetPlaybackStatusInternal(TEnumAsByte<EMovieScenePlayerStatus::Type> InStatus) {
}
...
EMovieScenePlayerStatusK2 UMovieSceneSequencePlayer::K2_GetPlaybackStatus() const {
    return EMovieScenePlayerStatusK2::Stopped;
}
...
void UMovieSceneSequencePlayer::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const {
    ...
    DOREPLIFETIME(UMovieSceneSequencePlayer, bPlaybackCompleted);
}
