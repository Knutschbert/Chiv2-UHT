...
#include "EControlRotationType.h"
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bEnabledUseControllerRotationPitch;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bEnabledUseControllerRotationYaw;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    bool bEnabledUseControllerRotationRoll;
...
public:
    ...
    bool UseControllerRotationYaw() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool UseControllerRotationRoll() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool UseControllerRotationPitch() const;
    ...
    UFUNCTION(BlueprintCallable)
    void RevokeDisableUseControllerRotation(EControlRotationType Rotation, UObject* Requester);
    
    UFUNCTION(BlueprintCallable)
    void RequestDisableUseControllerRotation(EControlRotationType Rotation, UObject* Requester);
