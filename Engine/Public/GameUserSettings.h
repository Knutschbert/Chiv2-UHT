...
public:
    ...
    bool SupportsNGXDLSS() const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    bool SupportsNGX() const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    void NGXDriverUpdateRequired(bool& DriverOutOfDate, int32& MinDriverVersionMajor, int32& MinDriverVersionMinor) const;
