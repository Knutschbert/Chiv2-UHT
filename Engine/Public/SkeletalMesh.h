...
#include "SkelMeshVertexSelectionSetsItem.h"
...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FPerPlatformBool DisableMorphTargets;
    ...
    uint8 bAllowGPUMorphTargetUpdate: 1;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 bWillNeverMergeMesh: 1;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FSkelMeshVertexSelectionSetsItem VertexSelectionSets;
