...
UCharacterMovementComponent::UCharacterMovementComponent() {
    ...
    this->bHasQueuedServerTeleport = false;
    ...
    this->ParallelUpdateIndex = -1;
    this->ParallelUpdateFrameNumber = 0;
    this->ParallelUpdateDesiredMoveMode = MOVE_None;
    this->bAllowParallelUpdate = true;
    ...
    this->NetworkSimulatedSmoothRotationLimit = 0.00f;
    ...
    this->SyncTimerCounter = 0;
    this->ServerMoveDeltaTime = 0.00f;
    this->LastClientTimeStamp = 0.00f;
    this->bIsDualMove = false;
    this->bIsFirstDualMove = false;
    this->LastServerMoveFrame = 0;
}
