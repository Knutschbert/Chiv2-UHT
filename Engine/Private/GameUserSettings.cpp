...
bool UGameUserSettings::SupportsNGXDLSS() const {
    return false;
}

bool UGameUserSettings::SupportsNGX() const {
    return false;
}
...
void UGameUserSettings::NGXDriverUpdateRequired(bool& DriverOutOfDate, int32& MinDriverVersionMajor, int32& MinDriverVersionMinor) const {
}
