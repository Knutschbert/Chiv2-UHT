...
UInputSettings::UInputSettings() {
    ...
    this->ActionMappingWhitelist.AddDefaulted(11);
    this->ActionMappingInGameWhitelist.AddDefaulted(14);
    this->ActionMappings.AddDefaulted(165);
    this->AxisMappings.AddDefaulted(34);
