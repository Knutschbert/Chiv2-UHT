...
AGameNetworkManager::AGameNetworkManager() {
    ...
    this->MAXPOSITIONERRORSQUARED = 256.00f;
    ...
    this->MovementTimeDiscrepancyResolutionThreshold = 3.00f;
    ...
    this->MovementTimeDiscrepancyDriftAllowance = 0.10f;
    this->bMovementTimeDiscrepancyForceCorrectionsDuringResolution = true;
