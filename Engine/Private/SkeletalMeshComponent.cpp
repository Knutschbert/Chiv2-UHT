...
void USkeletalMeshComponent::SetMorphTarget(FName MorphTargetName, float Value, bool bRemoveZeroWeight, bool bRefreshMorphTargets) {
}
...
USkeletalMeshComponent::USkeletalMeshComponent() {
    ...
    this->bSkipSyncComponentToRBPhysics = false;
    ...
    this->bEnableBoundsUpdateRateOptimizations = false;
    this->bWasVisibleAtLastBoundsCalc = false;
    this->BoundsUpdateInterval = 1.00f;
    this->BoundsUpdateTime = 0.00f;
    this->UpdateTransformKernel.AddDefaulted(1);
    this->bForceCreatePhysicsState = false;
    ...
    this->bDisableLateAnimEval = false;
    this->bLateAnimEvalTaskValid = false;
    this->ClothingInteractor = NULL;
    this->CurrentPooledPhysicsAsset = NULL;
}
