...
bool APawn::UseControllerRotationYaw() const {
    return false;
}

bool APawn::UseControllerRotationRoll() const {
    return false;
}

bool APawn::UseControllerRotationPitch() const {
    return false;
}
...
void APawn::RevokeDisableUseControllerRotation(EControlRotationType Rotation, UObject* Requester) {
}

void APawn::RequestDisableUseControllerRotation(EControlRotationType Rotation, UObject* Requester) {
}
...
APawn::APawn() {
    ...
    this->bEnabledUseControllerRotationPitch = false;
    this->bEnabledUseControllerRotationYaw = false;
    this->bEnabledUseControllerRotationRoll = false;
