...
ARecastNavMesh::ARecastNavMesh() {
    ...
    this->TilePoolSize = 13500;
    this->TileSizeUU = 1000.00f;
    this->CellSize = 8.00f;
    this->CellHeight = 10.00f;
    this->AgentRadius = 46.00f;
    this->AgentHeight = 200.00f;
    this->AgentMaxHeight = 200.00f;
    this->AgentMaxSlope = 41.00f;
    this->AgentMaxStepHeight = 40.00f;
    this->MinRegionArea = 500.00f;
