...
public:
    ...
    UUserWidgetContainer* WidgetCluster;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Transient, meta=(AllowPrivateAccess=true))
    TArray<UObject*> ObjectsToAddAsMutable;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 bUseGCCluster: 1;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 bForceNoGCCluster: 1;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    uint8 bWidgetClusterCreated: 1;
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    void AddToClusterAsMutable(UObject* Object);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    void AddClassToClusterAsMutable(UClass* Klass);
