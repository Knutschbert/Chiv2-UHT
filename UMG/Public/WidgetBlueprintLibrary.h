...
public:
    ...
    static void SetInputMode_UIOnlyEx(UObject* WorldContextObject, APlayerController* PlayerController, int32& InputIdNum, UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, int32 LastInputIDNum);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic)
    static void SetInputMode_UIOnly(APlayerController* Target, UWidget* InWidgetToFocus, bool bLockMouseToViewport);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta=(WorldContext="WorldContextObject"))
    static void SetInputMode_GameOnly(UObject* WorldContextObject, APlayerController* PlayerController, int32& InputIdNum, int32 LastInputIDNum);
    
    UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta=(WorldContext="WorldContextObject"))
    static void SetInputMode_GameAndUIEx(UObject* WorldContextObject, APlayerController* PlayerController, int32& InputIdNum, UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, bool bHideCursorDuringCapture, int32 LastInputIDNum);
