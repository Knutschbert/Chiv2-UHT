...
void UUserWidget::AddToClusterAsMutable(UObject* Object) {
}

void UUserWidget::AddClassToClusterAsMutable(UClass* Klass) {
}

UUserWidget::UUserWidget() {
    this->WidgetTree = NULL;
    this->WidgetCluster = NULL;
    this->Priority = 0;
    ...
    this->bUseGCCluster = false;
    this->bForceNoGCCluster = false;
    this->bWidgetClusterCreated = false;
