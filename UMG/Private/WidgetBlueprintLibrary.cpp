...
void UWidgetBlueprintLibrary::SetInputMode_UIOnlyEx(UObject* WorldContextObject, APlayerController* PlayerController, int32& InputIdNum, UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, int32 LastInputIDNum) {
}
...
void UWidgetBlueprintLibrary::SetInputMode_GameOnly(UObject* WorldContextObject, APlayerController* PlayerController, int32& InputIdNum, int32 LastInputIDNum) {
}

void UWidgetBlueprintLibrary::SetInputMode_GameAndUIEx(UObject* WorldContextObject, APlayerController* PlayerController, int32& InputIdNum, UWidget* InWidgetToFocus, EMouseLockMode InMouseLockMode, bool bHideCursorDuringCapture, int32 LastInputIDNum) {
}
